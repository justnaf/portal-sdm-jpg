                    ...
                    <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="md:flex md:items-center mb-3">
                            ...
                            <div class="md:w-2/3">
                                <input
                                    class="bg-gray-200 appearance-none border-2 border-slate-50 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-orange-500"
                                    id="inline-username" type="text" name="username">
                        ...
                        <div class="md:flex md:items-center mb-3">
                            ...
                            <div class="md:w-2/3">
                                <input
                                    class="bg-gray-200 appearance-none border-2 border-slate-50 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-orange-500"
                                    id="inline-email" type="text" name="email">
                        ...
                        <button type="submit"
                            class="bg-green-500 p-3 rounded-lg font-bold text-white shadow-md">Tambah</button>
                    </form>
